...
public class Main {
	...
	public static void main(String[] args) throws ClientProtocolException,
		...
		seo.common.BlogSender.sendUseDriverGet(ReMenUrl, 1, 500, param);
		seo.common.BlogSender.sendUseDriverGet(TuiJianUrl, 1, 407, param);
		seo.common.BlogSender.sendUseDriverGet(ZuiXinUrl, 1, 500, param);
